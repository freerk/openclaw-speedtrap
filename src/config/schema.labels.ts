...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.slack.socketMode.clientPingTimeout": "Slack Socket Mode Client Ping Timeout",
  "channels.slack.socketMode.serverPingTimeout": "Slack Socket Mode Server Ping Timeout",
  "channels.slack.socketMode.pingPongLoggingEnabled": "Slack Socket Mode Ping/Pong Logging",
