...
/**
 * after_agent_complete hook — fires after an agent produces a response,
 * before delivery (for non-streaming channels). Allows plugins to decide
 * whether to deliver, suppress, or reinject the response.
 */
